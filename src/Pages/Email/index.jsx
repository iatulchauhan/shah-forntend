    ...
    return (
        <>
            <Grid container spacing={3} style={{ marginLeft: '0px' }}>
                <Grid item xs={4} sm={4} md={4} lg={4} padding={4}
                                ...
                                <Box display={'flex'} justifyContent={"space-between"} mb={1}>
                                    <Box display={'flex'} gap={1} alignItems={"center"}>
                                        ...
                                        <Box>
                                            ...
                                            <SectionHeading variant={"caption"} title={data.name} color={lightTheme.palette.bgLightExtraLightGray.main} />
                                        </Box>
                                    </Box>
                                    <SectionHeading variant={"caption"} color={lightTheme.palette.bgLightExtraLightGray.main} title={data.time} />
                                </Box>
                                <Box>
                                    <TextLabel variant={"body2"} color={lightTheme.palette.bgLightExtraLightGray.main} fontWeight={"400"} title={data.data} />
                                </Box>
                            </Box>
                        )
                    })}
                ...
                <Grid item xs={8} sm={8} md={8} lg={8}>
                    <Box padding={4} sx={{ background: 'var(--White, #FFF)' }}>
                        <Box display={"flex"} justifyContent={"center"} my={4}>
                            <SectionHeading fontWeight={"400"} variant={"subtitle2"} color={lightTheme.palette.bgLightExtraLightGray.main} title={"Load 3 previous messages"} />
                        </Box>
                        <Box display={'flex'} justifyContent={"space-between"} mb={1}>
                            <Box display={'flex'} gap={1} alignItems={"center"}>
