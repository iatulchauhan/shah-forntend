...
const AddScheduleMeeting = ({ data, error, handleChange, isEdit, onSubmit, slotTimes, convertToAmPm, setSelectedSlot, selectedSlot, setData, meetingVisitorList, setSelectedInviteTo, selectedInviteTo, selectedClient, setSelectedClient, handleSlotClick, meetingCounsellorList }) => {
            ...
            <Grid container spacing={1} xs={12} md={12} lg={12} sm={12} p={2}>
                ...
                <Grid item xs={12} sm={12} md={12} lg={12}>
                    <AutoCompleteSearch
                        ...
                        options={meetingVisitorList?.response?.map((e) => e?.name) || []}
                        name="selectedClient"
                ...
                <Grid item xs={12} sm={12} md={12} lg={12}>
                    <AutoCompleteSearch
                        ...
                        options={meetingCounsellorList?.response?.map((e) => e?.name) || []}
