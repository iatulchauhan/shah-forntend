...
import { setLSItem } from "./APiSetUp/LocalStorage";
...
export const requestForToken = () => {
  return getToken(messaging, { vapidKey: "BAgWm0q-SCuyrmaB3rcM-eA-JQJuhu8SHEQeh1UpqN-GpwPcSDIyexNCyiooR8pNzV2WEmVDr-tfTsxqc9W6XZ0" })
    .then((currentToken) => {
      if (currentToken) {
        setLSItem("deviceToken", currentToken)
